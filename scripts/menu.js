...
//------------------------------------------------------------------------------------ "Javascrpting" color change
    ...
    $(".title-link").mouseout(function() {
        $(this).css("color", "white");                              //Turns "Javascripting" white on mouseleave 
        //console.log(event.type);
    });

//------------------------------------------------------------------------------------ Menu, bars and no-dropdown menu items color
    $(".menu-text, .fontawesome-icon, .menu-list, .menu-list-with-dropdown").mouseover(function() {
    ...
    $(".menu-text, .fontawesome-icon, .menu-list").mouseout(function() {
